...
<body>
  ...
  <form method="post" action="register_dblink.php">
    ...
    <input type=hidden name="超大豪華雙人房" value="<? echo $超大豪華雙人房 ?>">
    <input type=hidden name="豪華雙人房" value="<? echo $豪華雙人房 ?>">
    <input type=hidden name="豪華三人房" value="<? echo $豪華三人房 ?>">
    <input type=hidden name="豪華單人房" value="<? echo $豪華單人房 ?>">

    <section id="hero">
      <section id="about" class="about">
        <div class="container" style=" width:50% ;background-color:whitesmoke; opacity: 0.9; margin-top: 80px; padding: 30px;">
          <h1 style="text-align: center; color:#3C3C3C;">註冊</h1>
          <p style="text-align: center; color:#CE0000; letter-spacing: 2px;">*為必填項目</p>

          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">*姓名</span>
            <input name="name" type="text" class="form-control" required value="<? echo $name ?>">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">*電話</span>
            <input name="phone" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" required value="<? echo $phone ?>">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">電子信箱</span>
            <input name="mail" type="text" placeholder="@gmail.com" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" value="<? echo $mail ?>">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">*帳號</span>
            <input name="account" placeholder="建議學生使用學號" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" required value="<? echo $account ?>">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">*密碼</span>
            <input name="password" type="password" class="form-control" aria-label="Username" aria-describedby="basic-addon1" required value="<? echo $password ?>">
          </div>

          <center>
            <p style="text-align: center; color:#CE0000; letter-spacing: 2px;"><a href="login_user.php">已有帳號?點此登入</a></p>
            <button type="submit" class="btn btn-danger" data-bs-toggle="modal" style="color: aliceblue;">確認註冊</button>
          </center>
        </div>
      </section>
    </section>
