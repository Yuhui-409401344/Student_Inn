...
if ($_SESSION['level'] <> "admin") {
    ...
    $id = $_GET['id'];
    $method = "manager_comment_update";
    $link = mysqli_connect("localhost", "root", "12345678", "manager_webfinal");
    $sql = "select * from web_user_feedback where id = '$id'";
...
<body>
    ...
    ?>
    <form method="post" action="manager_comment_dblink.php">
                    ...
                    <div class="row mt-5 justify-content-center" data-aos="fade-up">
                        <div class="col-lg-10" style="margin-top: 30px;">
                            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                <center>
                                    <h1><b style="color:#94c045;">修改</b>留言專區</h1>
                                            ...
                                            <div class="card-body">
                                                <div id="comment-2" class="comment" style="padding-left: 5%;">
                                                    <div class="d-flex" style="text-align:left;">
                                                        ...
                                                        <div>
                                                            <p style="font-size: 5px;"><b><u>評論編號<? echo $id ?></u></b></p>
                                                            <h5 style="color:#0066CC;"><b><i class="fas fa-user-circle"></i> 帳號【<? echo $account ?>】</b> <a href="#" class="reply"></a></h5>
                                                            <time datetime="2020-01-01"></time>
                                                            <h6><b><? echo $comment ?></b></h6>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div id="comment-reply-1" class="comment comment-reply">
                                                        <div class="d-flex">
                                                            <div>
                                                                <h5 style="color:#94c045;"><i class="fas fa-store-alt"></i><b> 業主回覆</b>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <textarea name="reply" type="text" class="form-control" id="recipient-name"><? echo $reply ?></textarea>
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" style="font-size: 13px; margin-left:80%;">確認修改</button>
                                                </div>
                                            </div>
                                            </tr>
                                    </table>
