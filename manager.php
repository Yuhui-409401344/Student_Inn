...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.php">SCHOLAR'S INN</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="news.php">公告區修改</a></li>
          <li><a href="booked.php" >顧客訂房一覽表</a></li>
          <li><a href="report.php" >營運報表</a></li>
          
         
          <li><a href="manager.php"  class="active">管理者資料</a></li>
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="accordion" id="accordionPanelsStayOpenExample">
                ...
                <h1 style="text-align: center;"><b>鈺惠貴賓，您好!</b></h1>
                <div class="accordion-item">
                  ...
                  <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                    <!-- ======= 第一列 ======= -->
                    <button style="color:tomato; font-weight: bold; font-size: 20px;" class=" accordion-button"
                         ...
                         <tbody>
                          ...
                          <table>
                            <center>
                              ...
                              data-bs-target="#staticBackdrop_false">
                              <button type="button" class="btn btn-success" style="font-size: 5px;">修改資料</button>
                            </div>
                              <div class="btn-group" role="group" aria-label="Basic mixed styles example" title="取消後將刪除此筆資料"
                              data-bs-toggle="modal" data-bs-target="#staticBackdrop_delet">
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                    <!-- ======= 第二列 ======= -->
                    <button style="color:tomato; font-weight: bold; font-size: 20px;" class="accordion-button collapsed"
                        ...
                        <thead>
                         ...
                         <tbody>
                          ...
                          <table>
                            <center>
                              <div class="btn-group" role="group" aria-label="Basic mixed styles example" data-bs-toggle="modal"
                              data-bs-target="#change_2">
                              <button type="button" class="btn btn-success" style="font-size: 5px;">修改資料</button>
                            </div>
                              <div class="btn-group" role="group" aria-label="Basic mixed styles example" title="取消後將刪除此筆資料"
                              data-bs-toggle="modal" data-bs-target="#delet_2">
                              <button type="button" class="btn btn-danger" style="font-size: 5px;">取消訂房</button>
                              </div>
                            </center>
                          ...
                          <div class="row">
                            <div class="col form-group ">
                              <textarea name="comment" class="form-control"
                                placeholder="請寫下此次訂房的建議，幫助我們提供更好的服務!"></textarea>
                            </div>
                          </div>
                          <br>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="recipient-name" placeholder="請填寫須更正的資料，無請寫無">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="recipient-name" class="col-form-label">信用卡卡號綁定:</label>
              <input type="text" class="form-control" id="recipient-name" placeholder="請填寫須更正的資料，無請寫無">
            </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" data-bs-dismiss="modal">確認修改</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- 訂房資料修改1 -->
  <div class="modal fade" id="staticBackdrop_false" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <tbody>
              ...
              <td>
                <div class="input-group mb-3">
                  ...
                  <input type="text" style="width:8px; height:30px;" class="form-control" placeholder="重新輸入"
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="Basic mixed styles example" title="取消後將刪除此筆資料"
                    data-bs-toggle="modal" data-bs-target="#staticBackdrop_money">
  ...
  <!-- 訂房資料修改2 -->
  <div class="modal fade" id="change_2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
 ...
 <!-- 可以取消訂房 -->
 <div class="modal fade" id="delet_2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
 aria-labelledby="staticBackdropLabel" aria-hidden="true">
 <div class="modal-dialog">
   <div class="modal-content">
     <div class="modal-header">
   ...
   <!-- 入住當天無法刪除 -->
   <div class="modal fade" id="staticBackdrop_delet" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
   aria-labelledby="staticBackdropLabel" aria-hidden="true">
   <div class="modal-dialog">
     <div class="modal-content">
       <div class="modal-header">
  ...
  <!-- Modal_MONEY -->
  <div class="modal fade" id="staticBackdrop_money" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
