          ...
          <li><a href="index.php">回首頁</a></li>
              ...
              <li class="dropdown"><a href="#" class="active"><span>房型瀏覽</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  ...
                  <li><a href="豪華雙人_view.php">豪華雙人房</a></li>
                  <li><a href="豪華單人_view.php">豪華單人房</a></li>
                  <li><a href="豪華三人_view.php" class="active">豪華三人房</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img src="assets/img/pingtung/three_bed.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="豪華三人_view.php">豪華三人房</a>
              </h2>
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="fas fa-users"></i> <a href="blog-single.php">&nbsp;三人房</a></li>
              ...
              <div class="entry-content">
                ...
                <h3>大空間獨立衛浴</h3>
                <p>
                  <i class="fas fa-toilet"></i>&nbsp;享受獨立空間，加大空間，提供最佳入住品質。
                </p>
                <img src="assets/img/pingtung/bathroom_1.jpg" class="img-fluid" alt="">
                <br>
