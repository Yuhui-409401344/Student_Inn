                    ...
                    <div class="row mt-5 justify-content-center" data-aos="fade-up">
                        <div class="col-lg-10" style="margin-top: 30px;">
                            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                ...
                                <center>
                                    <h1><b style="color:#94c045;">新增</b>促銷方案</h1>
                                    <table style="width:90%;">
                                        <tr>
                                            <td style="width: 50%; padding: 15px;">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1">促銷編號</span>
                                                    <input name="id" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $id ?>" require>
                                                </div>
                                            </td>
                                            <td style="width: 50%; padding: 15px;">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1">促銷名稱</span>
                                                    <input name="name" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $name ?>" require>
                                                </div>
                                            </td>
                                            </td>
                                        </tr>
                                        ...
                                        <div>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                                    ...
                                                    <input name="big_two" type="hidden" value="超大豪華雙人房">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                        ...
                                        <div>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                                    ...
                                                    <input name="two" type="hidden" value="豪華雙人房">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                        ...
                                        <div>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                                    ...
                                                    <input name="one" type="hidden" value="豪華單人房">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                        ...
                                        <div>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                                    ...
                                                    <input name="three" type="hidden" value="豪華三人房">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 50%; padding: 15px;" colspan="2">
                                            ...
                                            <td style="width: 50%;padding: 15px;">
                                                <center>
                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example" title="取消後將刪除此筆資料" data-bs-toggle="modal" data-bs-target="#delet_fix">
                                                        <button type="button" class="btn btn-danger" style="font-size: 5px;">重新輸入</button>
                                                    </div>
                                                </center>
                                            </td>
                                            <td style="width: 50%;padding: 15px;">
                                                <center>
                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example" title="新增資料" data-bs-toggle="modal" data-bs-target="#sure_fix">
                                                        <button type="button" class="btn btn-success" style="font-size: 5px;">新增</button>
                                                        <!-- <input type="button" onclick="myFunction()" value="123"> -->
                ...
                <div class="modal-content">
                    ...
                    <center>
                        <div class="modal-body">
                            ...
                            <br>
                            <span style="color:#FF0000;letter-spacing: 2px;"><b>確定要重新輸入資料嗎?</b></span>

                        </div>
                    </center>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><a style=color:white; href=coupon_insert.php>確定</a></button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <center>
                        <div class="modal-body">
                            ...
                            <br>
                            <span style="color:#FF0000;letter-spacing: 2px;"><b>已成功新增!</b></span>
