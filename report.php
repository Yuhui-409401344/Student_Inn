...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div width="100%" border="0" style="display: flex; flex-direction: row;">
          <div style="width: 20%; display: flex; flex-direction: column;padding-top: 2%;">
            <h6 style="color:#94c045;"><i class="fas fa-circle"
                style="font-size: 8px;padding-bottom: 3px;"></i>&nbsp;<b>2021年各月入住狀況營收</b></h6>
            <br>
            <div class="select1">
              <div class="mt-2 mb-2"><a href="2021年度.php" target="pic">2021年度入住狀況營收</a></div>
            </div>
            <div class="select1">
              <div class="mt-2 mb-2"></div><a href="修改2021年度入住狀況營收.php" target="pic">修改2021年度營收資料</a>
            </div>
            <br>
            <h6 style="color:#94c045;"><i class="fas fa-circle"
                style="font-size: 8px;padding-bottom: 3px;"></i>&nbsp;<b>2021年各房型入住狀況營收</b></b></h6>
            <br>
            <div class="select1">
              <div class="mt-2 mb-2"></div><a href="超大豪華雙人房_report.php" target="pic">超大豪華雙人房</a>
            </div>
            <div class="select1">
              <div class="mt-2 mb-2"></div><a href="豪華雙人房_report.php" target="pic">豪華雙人房</a>
            </div>
            <div class="select1">
              <div class="mt-2 mb-2"></div><a href="豪華單人房_report.php" target="pic">豪華單人房</a>
            </div>
            <div class="select1">
              <div class="mt-2 mb-2"><a href="豪華三人房_report.php"  target="pic">豪華三人房</a></div>
            </div>
          </div>
          <!-- iframe的地方 -->
          <div width="80%">
            <iframe src="index_3.php" frameborder="0" name="pic" width="900px" height="100%"></iframe>
          </div>
        </div>
      </div>
    </section>
  ...
  <!-- 訂房資料修改1 -->
  <div class="modal fade" id="manager_fix" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="fix.php" style="color: cornsilk;"><button type="button" class="btn btn-primary"
              data-bs-dismiss="modal">確認</a></button>
        </div>
      </div>
    </div>
  </div>
