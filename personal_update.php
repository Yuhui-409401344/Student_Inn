...
<body>
    ...
    <form method="post" action="personal_dblink.php">
                                        ...
                                        <tr>
                                            <td style="width: 50%; padding: 15px;" colspan="2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="price" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $price ?>" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
