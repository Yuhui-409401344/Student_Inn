      ...
      <div class="container">
        ...
        <div width="100%" border="0" style="display: flex; flex-direction: row;">
          <div style="width: 20%; display: flex; flex-direction: column;padding-top: 2%;">
            <h6 style="color:#94c045;"><i class="fas fa-circle" style="font-size: 8px;padding-bottom: 3px;"></i>&nbsp;<b>最新促銷方案</b></h6>
            <br>
            ...
            ?>
              <div class="select1">
                <div type="submit" class="mt-2 mb-2"><? echo "<a href=coupon_update.php?method=manager_update&id=$record[0] target=pic>" ?> <? echo  $record[1] ?></a></div>
              </div>
            <?
            }
            ?>
            <div class="select2">
              <div class="mt-2 mb-2"><a href="coupon_insert.php?method=coupon_insert" target=pic><i class="fas fa-plus-circle"></i></a></div>
            </div>
          </div>
          <div width="80%">
            <iframe src="index_2.php" frameborder="0" name="pic" width="900px" height="100%"></iframe>
          </div>
