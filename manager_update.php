...
<body>
    ...
    ?>
    <form method="post" action="manager_dblink.php">
                                        ...
                                        <tr>
                                            <td style="width: 50%; padding: 15px;" colspan="2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="id" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $id ?>" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; padding: 15px;">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="name" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $name1 ?>">
                                                </div>
                                            </td>
                                            <td style="width: 50%;padding: 15px;">
                                                <select name="room" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                                    <option selected><? echo $room ?></option>
                                        ...
                                        <tr>
                                            <td style="width: 50%; padding: 15px;">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="date_in" type="date" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $date_in ?>">
                                                </div>
                                            </td>
                                            <td style="width: 50%;padding: 15px;">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1">退房日期</span>
                                                    <input name="date_out" type="date" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $date_out ?>">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; padding: 15px;">
                                                ...
                                                <select name="pay" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                                    <option selected><? echo $pay ?></option>
                                                    <option value="現金付款(含五倍券)">現金付款(含五倍券)</option>
                                                    <option value="信用卡付款">信用卡付款</option>
                                                    <option value="郵局轉帳">郵局轉帳</option>
                                                </select>
                                            </td>
                                            </td>
                                            <td style="width: 50%; padding: 15px;">
                                                <select name="coupon" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                                    <option selected><? echo $coupon ?></option>
                                                    <option value="無">無</option>
                                                    <option value="早鳥優惠">早鳥優惠</option>
                                                    <option value="五倍券優惠">五倍券優惠</option>
                                                    <option value="學生證優惠">學生證優惠</option>
                                                    <option value="首次入住優惠">首次入住優惠</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; padding: 15px;" colspan="2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="price" type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" value="<? echo $price ?>">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="width: 50%;padding: 15px; padding-left:80%;">
                                                <button type="submit" class="btn btn-success" style="font-size: 5px;">確定修改</button>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
