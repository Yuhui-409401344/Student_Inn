                ...
                <div class="row mt-5 justify-content-center" data-aos="fade-up">
                    <div class="col-lg-10" style="margin-top: 30px;">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form" style="margin: 5%;">
                            <center>
                                <h1>很抱歉 ， <b style="color:#EA0000;">無法取消訂房 !</b></h1>
                                <table style="width:90%;">
                                    ...
                                    <tr>
                                        <td>
                                       <center>
                                        <div class="alert alert-danger" role="alert" style="margin-right:5%;margin-left:5%;padding-top:3%;">
                                            <h5><p>入住當天已無法取消訂房，任何疑問歡迎來電洽詢。</p></h5>
                                            <h6><p> <i class="fas fa-calendar-times"></i> : <? echo date('Y 年 m 月 d 日') ?></p></h6>
                                            <h6><p>( <i class="fas fa-phone"></i> : 02-2904-5537 )</p></h6>
                                        </div>
                                        </center>
                                        </td>
                                    </tr>
